    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <p className="text-sm text-muted-foreground">Sign in to manage your business listings</p>
        </DialogHeader>
        ...
        <div className="space-y-2.5">
          ...
          <Button
            variant="outline"
            className="w-full h-11 justify-start gap-3 font-medium"
            onClick={() => { setMethod("whatsapp"); setConfirmResult(null); }}
            disabled={!!socialLoading}
          >
          ...
          <div className="space-y-3">
            {!confirmResult ? (
              <>
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className={method === "whatsapp" ? "pl-10" : ""}
                      value={phone}
                ...
                <Button className="w-full" onClick={() => handleSendOTP(method === "whatsapp")} disabled={loading}>
                  {loading && <Loader2 className="w-4 h-4 mr-2 animate-spin" />}
                  Send OTP
                </Button>
              </>
              ...
              <>
                <div className="space-y-2">
                  ...
                  <Input type="text" placeholder="123456" value={otp} maxLength={6} onChange={(e) => setOtp(e.target.value)} />
                </div>
