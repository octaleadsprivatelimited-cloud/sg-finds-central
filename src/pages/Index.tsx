...
const DEMO_LISTINGS: (Listing)[] = [
  ...
  { id: "3", name: "Glow Aesthetics Clinic", uen: "202212345C", category: "Beauty & Wellness", district: "Novena", address: "10 Sinaran Drive, #10-05, Singapore 307506", postalCode: "307506", phone: "+65 6345 6789", email: "appointments@glowaesthetics.sg", description: "Premium aesthetic treatments using FDA-approved technology.", status: "approved", ownerId: "demo", lat: 1.3204, lng: 103.8447, verified: true, rating: 4.7, reviewCount: 64, offers: [{ id: "o2", title: "New Client Package", description: "First facial treatment at 50% off", discount: "50% OFF", validUntil: "2026-05-31", code: "GLOW50" }, { id: "o3", title: "Refer a Friend", description: "Get $20 credit when you refer a friend", discount: "$20 Credit", validUntil: "2026-06-30" }] },
